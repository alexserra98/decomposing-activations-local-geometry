...
#SBATCH --job-name=toy30k_kmeans_k300
#SBATCH --output=/u/dssc/zenocosini/decomposing-activations-local-geometry/logs/jobs/toy30k_kmeans_k300_%j.out

set -euo pipefail

REPO_ROOT=/u/dssc/zenocosini/decomposing-activations-local-geometry
SHARD_DIR=$REPO_ROOT/dalg-cache/assets/toy_manifolds_circle_helix_torus_D128_30K_noise1e4_shards
OUT_DIR=$REPO_ROOT/dalg-cache/toy_manifold_models_30k/centroids/kmeans_k300
