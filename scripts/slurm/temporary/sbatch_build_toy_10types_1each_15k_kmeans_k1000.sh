...
#SBATCH --job-name=toy10x1_kmeans_k1k
#SBATCH --output=/u/dssc/zenocosini/decomposing-activations-local-geometry/logs/jobs/toy10x1_kmeans_k1000_%j.out

set -euo pipefail

REPO_ROOT=/u/dssc/zenocosini/decomposing-activations-local-geometry
SHARD_DIR=$REPO_ROOT/dalg-cache/assets/toy_manifolds_10types_1each_D128_15Keach_noise1e4_shards
OUT_DIR=$REPO_ROOT/dalg-cache/toy_manifold_models_10types_1each_15Keach/centroids/kmeans_k1000
